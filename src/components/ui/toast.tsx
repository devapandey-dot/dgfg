  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border p-4 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full",
  {
    variants: {
      variant: {
        ...
        destructive: "border-blue-100 bg-blue-50 text-blue-900",
      },
    },
    defaultVariants: {
      variant: "default",
...
// Framer Motion version for animated mount/unmount
const MotionToast = React.forwardRef<
  React.ElementRef<typeof ToastPrimitives.Root>,
  React.ComponentPropsWithoutRef<typeof ToastPrimitives.Root> & VariantProps<typeof toastVariants>
>(({ className, variant, children, ...props }, ref) => {
  return (
    <ToastPrimitives.Root asChild duration={3000} {...props}>
      <motion.div
        ref={ref as any}
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-gray-400 opacity-0 transition-opacity group-hover:opacity-100 group-[.destructive]:text-blue-400 hover:text-gray-900 group-[.destructive]:hover:text-blue-600 focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-blue-400",
      className,
    )}
    toast-close=""
    {...props}
